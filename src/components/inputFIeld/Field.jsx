...
const Field = ({ type = "text", disabled, placeHolder, name, ref, bgColor, value, className, onChange, xl, lg, md, isIcon, row, col, maxLength, color = "black", styles }) => {
   const [isPass, setIsPass] = useState(true);

   // input fields

   const inputClassName = `w-full border-none rounded-lg outline-none ${bgColor ? bgColor : "bg-[#F0F0F0]"} p-3 
