...
const DashTable = ({ head, data, yHeight, tableHeading }) => {
    ...
    return (
        <div className='border--2 border-[blue] bg-white-color box_shadow_sec rounded-xl w-full h-full overflow-hidden '>
            ...
            <div className={`w-full max-[1400px]:overflow-x-auto max-[650px]:w-[90vw] max-[450px]:w-[88vw] ${yHeight ? `${yHeight} overflow-y-auto` : ""} `}>
                <table className='w-full max-[1400px]:w-[46rem] max-[1280px]:w-full max-[650px]:w-[50rem] '>
                                        ...
                                        }
                                        {
                                            ...
                                            <td className={` text-center py-2 pr-8`}>
                                                <Button
                                                    ...
                                                    bgcolor="bg-primary--color" pClass="text-white--color text-black" style={{ borderRadius: "50px", paddingInline: "10px", paddingBlock: "5px" }} onClick={() => handleId(item.id)} />
                                            </td>
                                        }
                                    </React.Fragment>
                                ))}
